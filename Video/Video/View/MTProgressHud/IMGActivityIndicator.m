...
- (void)createLayers
{
    CGRect theFrame;
    if(self.percentage) {
        theFrame = CGRectMake(0, 0 ,CGRectGetWidth(self.frame), CGRectGetHeight(self.frame) + 22);
    }
    else {
        theFrame = CGRectMake(0, 0 ,CGRectGetWidth(self.frame), CGRectGetHeight(self.frame));
    }
